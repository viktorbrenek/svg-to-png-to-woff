...
const loadAssets = (_a) => __awaiter(void 0, [_a], void 0, function* ({ inputDir, getIconId }) {
...
const writeAssets = (assets_1, _b) => __awaiter(void 0, [assets_1, _b], void 0, function* (assets, { name, pathOptions = {}, outputDir }) {
    const results = [];
