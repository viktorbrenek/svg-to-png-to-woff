...
__webpack_require__.d(__webpack_exports__, {
  ...
  fromStringLegacy: () => (/* reexport */ fromStringLegacy),
...
function fromString(string) {
  var parseFloatOrThrow = function parseFloatOrThrow(number) {
    var n = parseFloat(number);
    if (Number.isFinite(n)) return n; // excludes NaN, +Infinite, -Infinite
    throw new Error("'".concat(string, "' is not a matrix"));
  };
  var prefix = string.substring(0, 7).toLowerCase();
  var suffix = string.substring(string.length - 1);
  var body = string.substring(7, string.length - 1);
...
var peg$allowedStartRules = (/* unused pure expression or super */ null && (["transformList"]));
